...
import com.nkoso.crowdfunding.service.AuthService;
...
public class AuthController {
    ...
    @Operation(summary = "Register a new user", description = "Create a new account with email and password. Returns a JWT token.")
